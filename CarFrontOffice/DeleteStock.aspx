...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnYes" runat="server" OnClick="btnYes_Click" style="z-index: 1; left: 13px; top: 77px; position: absolute; width: 56px" Text="Yes" />
        <asp:Button ID="bntNo" runat="server" style="z-index: 1; left: 75px; top: 78px; position: absolute; width: 62px" Text="No" />
    </form>
</body>
</html>
