...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnDeleteStaff" runat="server" style="z-index: 1; left: 168px; top: 482px; position: absolute; height: 25px; width: 50px" Text="Delete" OnClick="btnDeleteStaff_Click1" />
        <asp:Button ID="btnEditStaff" runat="server" style="z-index: 1; left: 97px; top: 482px; position: absolute; height: 25px; width: 50px; right: 1072px;" Text="Edit" OnClick="btnEditStaff_Click" />
        <asp:Button ID="btnAddStaff" runat="server" style="z-index: 1; left: 27px; top: 482px; position: absolute; height: 25px; width: 50px" Text="Add" OnClick="btnAddStaff_Click" />
