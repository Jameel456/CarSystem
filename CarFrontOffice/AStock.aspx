...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:Label ID="lblDateAdded" runat="server" style="z-index: 1; left: 15px; top: 197px; position: absolute; height: 22px;" Text="Date Added"></asp:Label>
        </div>
        ...
        <asp:Label ID="lblPrice" runat="server" style="z-index: 1; left: 18px; top: 161px; position: absolute" Text="Price"></asp:Label>
        ...
        <asp:Button ID="btnFind" runat="server" OnClick="btnFind_Click" style="z-index: 1; left: 343px; top: 36px; position: absolute" Text="Find" />
        <asp:Button ID="btnCancel" runat="server" style="z-index: 1; left: 191px; top: 351px; position: absolute" Text="Cancel" />
        <asp:Label ID="lblCarModel" runat="server" style="z-index: 1; left: 22px; top: 86px; position: absolute" Text="Car Model"></asp:Label>
        <asp:TextBox ID="txtModelNo" runat="server" style="z-index: 1; left: 137px; top: 46px; position: absolute"></asp:TextBox>
        <asp:Label ID="lblModelNo" runat="server" style="z-index: 1; left: 26px; top: 48px; position: absolute" Text="ModelNo"></asp:Label>
    </form>
</body>
</html>
